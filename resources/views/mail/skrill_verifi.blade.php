...
Skrill|NETELLER: {{ $sample_mail_text['request']['card'] }}<br>

Профиль на сайте: <a href="https://mainadmin.c1k.world/admin/users/{{ $sample_mail_text['user']['id'] }}">{{ $sample_mail_text['user']['email'] }}</a>
