<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="{{ route('admin.pairs.favorite') }}"><i class="fa fa-users"></i> <span>Избранные пары</span></a></li>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu" style="display: none">
          <li {{ ( url()->current() == route('admin.users.index') ) ? 'class="active"': '' }}><a href="{{ route('admin.users.index') }}"><i class="fa fa-users"></i> <span>Пользователи</span></a></li>
      ...
      ?>
      @isset($menu_coins)
      <li class="treeview {{ (url()->current() == route('admin.pairs.index'))&& request('coin_id') ? 'menu open' : '' }}">
        <a href="#">
        ...
        <ul class="treeview-menu" style="display: {{ (url()->current() == route('admin.pairs.index'))&& request('coin_id') ? 'block' : 'none' }}">

          @foreach($menu_coins as $menu_coins_title=>$menu_coins_link)
          <li {{ request('coin_id') == $menu_coins_link ? 'class=active' : '' }}>
      ...
      <li class="treeview {{ (url()->current() == route('admin.pairs.index'))&& request('city_id') ? 'menu open' : '' }}">
        <a href="#">
        ...
        <ul class="treeview-menu" style="display: {{ (url()->current() == route('admin.pairs.index'))&& request('city_id') ? 'block' : 'none' }}">

          @foreach($menu_exchanges as $menu_exchange)
          <li {{ request('city_id') == $menu_exchange->city_id ? 'class=active' : '' }}>
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu" style="display: none">
          ...
          <li><a href="{{ route('exportxmlok') }}"><i class="fa fa-users"></i> <span>Экспорт Okchange</span></a></li>
