        ...
        <div class="row">
            ...
            <div class="col">
                <div class="Fill" style="width:100%; text-align:center;">
                    <!-- <h4>@lang('account.card_verify.h4')</h4> -->
                    <div class="table-info-person-text mb-5">@lang('card_verify.title')</div>


                    @if( \Auth::user()->verified_send == 0)

                    <form method="POST" action="/account/card_verify" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="row row_magrin_z">
                            ...
                            <div class="col-lg-8 ">
                                ...
                                <div class="col-md-12 change-text-title-person ">
                                    <h4>@lang('card_verify.fill')</h4>
                                </div>

                                <div class="col-md-12 row text-person_data">
                                    <div class="col-md-3 col-sm-4 col-xs-6 text-left">
                                        <label class="col-form-label" for="inputFirstName">@lang('card_verify.name')</label>
                                    </div>
                                    <div class="col-md-9 col-sm-8 col-xs-6">
                                        <input type="text" class="form-control" name="first_name" id="inputFirstName"  placeholder="@lang('card_verify.name')" required>
                                    </div>
                                </div>
                                <div class="col-md-12 row text-person_data">
                                    <div class="col-md-3 col-sm-4 col-xs-6 text-left">
                                        <label class="col-form-label" for="inputTel">@lang('card_verify.phone')</label>
                                    </div>
                                    <div class="col-md-9 col-sm-8 col-xs-6">
                                ...
                                <div class="col-md-12 row text-person_data">
                                    <div class="col-md-3 col-sm-4 col-xs-6  text-left">
                                        <label class="col-form-label" for="inputCardNumber">@lang('card_verify.card_number')</label>
                                    </div>
                                    <div class="col-md-9 col-sm-8 col-xs-6">
                                ...
                                <div class="col-md-12 row text-person_data">
                                    <div class="col-md-3 col-sm-4 col-xs-6 text-left">
                                        <label class="col-form-label" for="inputCardFoto">@lang('card_verify.foto')</label>
                                    </div>
                                    <div class="col-md-9 col-sm-8 col-xs-6">
                                        ...
                                        <hr>
                                        <h4 class="alert-heading">@lang('card_verify.note')</h4>
                                        <p>@lang('card_verify.note1')</p>
                                        <hr>
                                        <a href="" onclick="event.preventDefault();$('.fotoInMobile').show()"role="button" class="btn btn-outline-secondary">@lang('card_verify.nopc')</a>
                                    </div>
                    ...
                    <div class="col-md-12 change-text-title-person ">
                        <h4>@lang('card_verify.pending')</h4>
                    </div>
